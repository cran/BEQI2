        ...
        d <- ddply(
            ...
            .fun = function(x) {
                ...
                ux$POOLID <- pool(
                    sampleId = ux$ID, 
                    area = ux$AREA, 
                    targetArea = settings[["target area"]]
                )
